...
export PATH=$PATH:/Users/bspar/Documents/nerve-endings/android-ndk-r19c
...
android () { hdiutil attach ~/android.dmg.sparseimage -mountpoint /Volumes/android; cd /Users/bspar/Documents/nerve-endings/aosptest/docker-aosp; docker-compose up -d --build; docker exec -it docker-aosp_aosp_1 bash }
